...
namespace Project
{
    public class Stats : IDisposable
    {
        ...
        { //increase or decrease health, meant for items or effects that modify health
        ...
        { //increase or decrease AP, meant for items or effects that modify AP
        ...
        public bool GiveAlive()
        { //just wrote this to get rid of a warning message
            return Alive;
        }
